...
<head>
	...
	<script src="<?php echo base_url(); ?>assets/javascripts/jquery.tablesorter/jquery.tablesorter.js"></script>
			...
			<tbody class="font3 search-body">
				<?php
					...
					for($i = 0; $i < sizeof($data); $i = $i + 1){
						...
						echo '<td><a class="button2" href="'.base_url().'index.php/book?id='.$data[$i]["id_jadwal"].'">BOOK NOW!</td>';
						echo '</tr>';
						$i = $i + 1;
					}
				?>
